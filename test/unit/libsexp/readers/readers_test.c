...
int main(int argc, char **argv)
{
    ...
    data_fname_str = "test/unit/libsexp/readers/case010.dune";
    readers_expected = read_expected("test/unit/libsexp/readers/case010.expected");
    ...
    /* data_fname_str = "test/unit/libsexp/readers/case020/dune"; */
    /* readers_expected = read_expected("test/unit/libsexp/readers/case020/sexp.expected"); */
    /* gc_expected = s7_gc_protect(s7, readers_expected); */
    /* RUN_TEST(read_file_port); */
    /* RUN_TEST(with_input_from_file_test); */
    /* RUN_TEST(call_with_input_file_test); */
    ...
    /* data_fname_str = "test/unit/libsexp/readers/case030/dune"; */
    /* readers_expected = read_expected("test/unit/libsexp/readers/case030/sexp.expected"); */
    /* gc_expected = s7_gc_protect(s7, readers_expected); */
    /* RUN_TEST(read_file_port); */
    /* RUN_TEST(with_input_from_file_test); */
    /* RUN_TEST(call_with_input_file_test); */
