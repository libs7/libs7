...
{
  s7_pointer cur_env;
  s7_pointer pcl_t, pl_tx, pl_ts, pl_ti, pl_txs, pl_iixiixi, pcl_i, pl_ix, pl_it, pcl_is, pl_is, pcl_ix, pcl_iix, pcl_isi, pl_ixi, pl_isi, pl_iix, pl_isx, pcl_ixi, pl_isxi, pl_iisi, pcl_iixi, pl_iixi, pl_issi, pl_ixxi, pcl_ixsi, pl_ixiix, pcl_di, pl_ds, pcl_s, pl_sx, pl_st, pl_si, pl_sis, pl_ssi, pl_sssi, pl_ssix, pl_sisi, pcl_x, pl_xs, pcl_xi, pl_xi, pl_xt, pcl_xs, pl_xxi, pcl_xxi, pl_xis, pl_xxxi, pl_xssx;
  {
  ...
  /* fprintf(stderr, "0 XXXXXXXXXXXXXXXX %d\n",  WRDE_SYNTAX); /\* obazl *\/ */
  /* s7_pointer wrde = s7_make_integer(sc, (s7_int)WRDE_SYNTAX); */
  /* fprintf(stderr, "made int XXXXXXXXXXXXXXXX\n"); */
  /* char *sss = s7_object_to_c_string(sc, wrde); */
  /* fprintf("WRDE: %s\n", sss); */
  /* free(sss); */

  /* fprintf(stderr, "1 XXXXXXXXXXXXXXXX %d\n",  WRDE_SYNTAX); /\* obazl *\/ */
