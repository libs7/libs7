...
/*  *\/ */
/* static int (*mustach_wrap_get_partial)(const char *name, struct mustach_sbuf *sbuf); */
...
/*  *\/ */
/* static int mustach_wrap_file(const char *template, size_t length, const struct mustach_wrap_itf *itf, void *closure, int flags, FILE *file); */
...
/*  * a other negative value in case of error. */
/*  *\/ */
/* static int mustach_wrap_fd(const char *template, size_t length, const struct mustach_wrap_itf *itf, void *closure, int flags, int fd); */
...
/*  * a other negative value in case of error. */
/*  *\/ */
/* static int mustach_wrap_write(const char *template, size_t length, const struct mustach_wrap_itf *itf, void *closure, int flags, mustach_write_cb_t *writecb, void *writeclosure); */
